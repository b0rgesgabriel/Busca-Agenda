    ...
    <div class="container">
        <div class="row mt-4">
            <div class="col-lg-12 d-flex justify-content-between align-items-center">
                <div>
                    <h4>Lista de Eventos Agenda EMERJ</h4>
                </div>
                <!-- <div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="cad-usuario-form">
                        ...
                        <div class="mb-3">
                            <label for="nome" class="col-form-label">Nome Apoio :</label>
                            <input type="text" name="apoio" class="form-control" id="apoio"
                                placeholder="Cadastrar apoio ao evento ">
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <dl class="row">
                            ...
                            <dd class="col-sm-9"><span id="title"></span></dd>

                            <dt class="col-sm-3">Transmissão</dt>
                            <dd class="col-sm-9"><span id="tsinal"></span></dd>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="edit-usuario-form">
                            ...
                            <div class="mb-3">
                                <label for="nome" class="col-form-label">Setor:</label>
                            ...
                            <div class="mb-3">
                                <label for="apoio" class="col-form-label">Apoio:</label>
                                <input type="text" name="apoio" class="form-control" id="apoio"
